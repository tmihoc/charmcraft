...
> See more: {ref}`upload-a-charm-to-charmhub`
...
> See more: {ref}`command-charmcraft-revisions`


## Promote a charm revision to a higher-ranking risk level

To promote a charm revision to a higher-ranking risk level, release it again, specifying the target risk level. E.g., if your charm was on `5/beta`, to promote it to `candidate`, run:
...
Alternatively,  use the GitHub `promote-charm` action.
...
> See more: {ref}`command-charmcraft-release`
...
> See more: `juju` | Download a charm
