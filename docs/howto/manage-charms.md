...
> See first: `juju` | Manage charms


## Initialise a charm project
...
> See more: {ref}`command-charmcraft-revisions`, {ref}`profile`, {ref}`list-of-files-in-a-charm-project`


> See more: {ref}`manage-extensions`

## Add charm project metadata

### Specify a name

To specify a name for your charm, in your charm's `charmcraft.yaml` file fill in the `name` key. E.g.,
...
To add terms of use for your char, in your charm's `charmcraft.yaml` file specify a value for the `terms` key. E.g.,
...
> See first: `juju` | Manage configurations
...
> See first: `juju` | Manage relations (integrations)
...
> See more: {ref}`command-charmcraft-pack`
...
See `juju` | Deploy a charm


## Register a charm name on Charmhub

See {ref}`manage-names`.

(upload-a-charm-to-charmhub)=
## Upload a charm to Charmhub

You will need to be logged in to Charmhub.

> See more: {ref}`manage-charmhub-login-status`

To upload the charm to Charmhub, use the `charmcraft upload` command followed by the your charm's filepath. E.g., if you are in the charm's root directory,
...
> See more: {ref}`command-charmcraft-upload`


If your charm has associated resources, you'll need to upload them to Charmhub as well.

> See more: {ref}`manage-resources`


Each time you upload a charm to Charmhub, that creates a revision (unless you upload the exact same file again). 

> See more: {ref}`manage-revisions`

## Release a charm

To release a charm, release your revision of choice to the target release channel. 

> See more: {ref}`release-a-revision-into-a-channel`


## Have a charm publicly listed on Charmhub
...
## Advertise and build a community for a charm
